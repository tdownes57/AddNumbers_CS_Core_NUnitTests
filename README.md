This repository includes code for a straightforward algorithm for adding (& subtracting) numbers of any size, 
   no matter how many digits.  You might have noticed that most calculating methods are limited in how many 
...
addition and subtraction can be re-engineered from scratch. 
